Felizmente existe uma ferramenta que simplificará nossa tarefa a partir de agora: as _variáveis_. :grin:
...
...estamos _atribuindo_ o valor `"janeiro"` para a variável `primeiro_mes`. Dito de maneira simples, estamos dando esse valor à variável. :relieved:
