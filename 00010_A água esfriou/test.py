  ...
  def test_encher_garrafa_térmica_deixa_em_1000_a_água_da_garrafa_térmica_se_tivesse_80(self):
    global agua_da_garrafa_termica
    agua_da_garrafa_termica = 80
    encher_garrafa()
    self.assertEqual(agua_da_garrafa_termica, 1000)

  def test_encher_garrafa_térmica_deixa_em_1000_a_água_da_garrafa_térmica_se_tivesse_180(self):
    global agua_da_garrafa_termica
    agua_da_garrafa_termica = 180
    encher_garrafa()
    self.assertEqual(agua_da_garrafa_termica, 1000)

  def test_encher_garrafa_térmica_deixa_em_1000_a_água_da_garrafa_térmica_se_tivesse_480(self):
    global agua_da_garrafa_termica
    agua_da_garrafa_termica = 480
    encher_garrafa()
    self.assertEqual(agua_da_garrafa_termica, 1000)  